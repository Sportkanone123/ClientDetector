...
public class Help {
    ...
    public static boolean handle(CommandSender sender, Command command, String label, String[] args) {
        if(sender instanceof Player){
            ...
            sender.sendMessage("cd help -> Get help about the plugin.");
            sender.sendMessage("cd player <client/version/mods/labyaddons> <player> -> Get information about a player.");
            sender.sendMessage("cd forge <player> -> Get the Forge Modlist of a player.");
        }
